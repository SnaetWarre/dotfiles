...
# Everforest Theme - Adapted from Omarchy
# Extracted colors from the original theme files

# Base colors
color0="#2d353b"  # Background
color1="#e67e80"  # Red
color2="#a7c080"  # Green
...
# Wallpaper path
wallpaper="$HOME/.config/hypr/themes/everforest-adapted/backgrounds/1-everforest.jpg"
