...
bind("XF86AudioMicMute", hl.dsp.exec_cmd("~/.config/hypr/scripts/toggle-microphone.sh"), { locked = true })
...
bind("XF86KbdBrightnessUp", hl.dsp.exec_cmd("asusctl leds next"), { repeating = true })
bind("XF86KbdBrightnessDown", hl.dsp.exec_cmd("asusctl leds prev"), { repeating = true })
bind("XF86Launch4", hl.dsp.exec_cmd("~/.config/hypr/scripts/cycle-aura-effect.sh"), desc("Cycle ASUS Aura lighting effect"))
bind("XF86Fn_F5", hl.dsp.exec_cmd("~/.config/hypr/scripts/cycle-asus-profile.sh"), desc("Cycle ASUS fan profile"))
bind("XF86Phone", hl.dsp.exec_cmd("~/.config/hypr/scripts/cycle-asus-profile.sh"), desc("Cycle ASUS fan profile"))
bind("Print", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot_full"), desc("Capture the current display"))
bind("XF86Display", hl.dsp.exec_cmd("~/.config/hypr/scripts/display-manager.sh choose"), desc("Choose display mode"))
bind("XF86TouchpadToggle", hl.dsp.exec_cmd("~/.config/waybar/scripts/touchpad-toggle.sh"), desc("Toggle touchpad"))
bind("XF86Sleep", hl.dsp.exec_cmd("systemctl suspend"), desc("Suspend the laptop", { locked = true }))
bind("XF86RFKill", hl.dsp.exec_cmd("~/.config/hypr/scripts/notify-airplane-mode.sh"), desc("Show airplane mode state", { locked = true }))
bind("XF86Launch3", hl.dsp.exec_cmd("rog-control-center"), desc("Open ROG Control Center"))
...
hl.window_rule({ name = "windowrule-10", match = { class = "^(polkit-gnome-authentication-agent-1|hyprpolkitagent|org.kde.polkit-kde-authentication-agent-1)(.*)$" }, float = true })
...
hl.window_rule({ name = "codex-background-tests", match = { class = "^(codex-background-test)$" }, workspace = "9 silent" })
