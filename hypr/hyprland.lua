...
bind(mainMod .. " + G", hl.dsp.exec_cmd("~/.config/hypr/scripts/gamemode.sh"), desc("Toggle game mode (Performance + disable tofi)"))
...
hl.window_rule({ name = "windowrule-2", match = { class = "^(Rofi|tofi)$" }, float = true })
...
hl.layer_rule({ name = "layerrule-tofi", match = { namespace = "tofi" }, blur = true })
